...
*/
        ...
        public void FilterBytesAreSeparatedCorrectly()
        {
            ...
            Assert.Equal(filter1Bytes, fb[0]);
            Assert.Equal(filter2Bytes, fb[1]);
        }
        ...
        public void AmplifierBytesAreSeparatedCorrecly()
        {
            ...
            Assert.Equal(source1AmplifierData, ab[0]);
            Assert.Equal(source2AmplifierData, ab[1]);
            Assert.Equal(source3AmplifierData, ab[2]);
            Assert.Equal(source4AmplifierData, ab[3]);
        }
